...
#define FLT_OTEL_PARSE_LOG_RECORD_TIME        "time"
#define FLT_OTEL_PARSE_LOG_RECORD_TIME_S      "s"
#define FLT_OTEL_PARSE_LOG_RECORD_TIME_MS     "ms"
#define FLT_OTEL_PARSE_LOG_RECORD_TIME_US     "us"
...
/* Punctuation of an HTTP token beside letters and digits (W3C baggage key). */
#define FLT_OTEL_PARSE_TOKEN_CHARS            "!#$%&'*+-.^_`|~"

/* Punctuation of a W3C tracestate key beside lower-case letters and digits. */
...
#define FLT_OTEL_PARSE_INSTR_DEFINES                                                                                                                                               \
	...
	FLT_OTEL_PARSE_INSTR_DEF(     OPTION, 0, NONE, 2, 2, "option",                        " { disabled | dontlog-normal | hard-errors | noflush | require-context }")          \
...
/* Format the parse error for a key that its unconditional line has closed. */
#define FLT_OTEL_PARSE_ERR_ALRUNCOND(e,v)     FLT_OTEL_PARSE_ERR((e), "'%s' : " FLT_OTEL_MSG_ALRUNCOND, (v))
