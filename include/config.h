...
#define FLT_OTEL_ID_MAXLEN        128           /* Identifier buffer size; a name runs to 127 characters. */
...
/* W3C limits on a span context field key, counted as the documents do. */
